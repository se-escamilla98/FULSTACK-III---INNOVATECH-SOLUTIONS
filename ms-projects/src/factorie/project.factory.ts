...
export class ProjectFactory {
  static create(name: string, description: string): Partial<Project> {
    // Regla de negocio: No se pueden registrar proyectos sin nombre ni descripción [cite: 36]
    ...
    return {
      name,
      description,
      status: "PLANNED", // Regla: Todo proyecto inicia con un estado definido [cite: 37, 40]
    };
  }
}